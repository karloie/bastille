...
2. **Comments must add context, not restate code** - Comments shall never repeat what the code says. Comments are for high-level contextualization only. Comments are for TODO/WARN/NOTE style guidance and other high-level context only.
